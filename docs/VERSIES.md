...
|---|---|---|
| Nocturne Official Release | 0.1.4 | Officiële release 0.2.4 |
| Nocturne Latest Release | 0.1.4 | Vastgezette daily/main-build, met commitcode en UTC-datum/tijd |
...
De statuspagina toont **HA-wrapper 0.1.4** prominent. Het volledige HA-pakketnummer
